...
import DataSink.GaussDBSink;

import java.util.Properties;

public class FlinkRealTimeCleaning {
    static final Logger logger = LoggerFactory.getLogger(FlinkRealTimeCleaning.class);
    ...
    private static void Cleaning() throws Exception {
...
//        keyedStream.print();//直接将从生产者接收到的数据在控制台上进行打印
        ...
        keyedStream.addSink(new GaussDBSink());

        // execute program
        env.execute("Flink Streaming Java API Skeleton");

    }
    private static void toKafka(){}
    private static void toGaussDB(){}
}
